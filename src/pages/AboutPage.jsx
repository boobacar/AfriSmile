  ...
  return (
    <main className="container-page py-10">
      ...
      <div className="mt-6 rounded-2xl bg-white p-6 shadow-soft">
        <p className="text-slate-700">AfriSmile est une entreprise spécialisée dans l’équipement dentaire en Afrique de l’Ouest. Notre mission est d’offrir des solutions fiables, accessibles et adaptées aux réalités des cabinets locaux.</p>
